...
def default_categorical_new():
    ...
    # continous output of throttle
    throttle_out = Dense(1, activation='elu', name='throttle_out')(x)  # Reduce to 1 number, Positive number only
